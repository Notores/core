...
class UserRouter {
    ...
    static async verifyEmailExists(req : Request, res : Response, next : NextFunction) {
    ...
    static async getById(rreq : Request, res : Response, next : NextFunction) {
