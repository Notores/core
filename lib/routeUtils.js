...
const routeActiveGuard = (handle) => function routeActiveGuard(req, res, next) {
...
const roleGuard = (roles) => function roleGuard(req, res, next) {
...
function unAuthenticatedGuard(req, res, next) {
